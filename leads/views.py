...
from .forms import LeadModelForm, UserCreationForm, AssignAgentForm, LeadCategoryUpdateForm, CategoryModelForm, FollowUpModelForm
...
class LeadCreateView(OrganisorAndLoginRequiredMixin, generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        send_mail(
            ...
            recipient_list=["receiver@domain.com"]
        )
...
class CategoryListView(LoginRequiredMixin, generic.ListView):
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        ...
        # Fetching lead count for each category
        categories = context["category_list"]
        for category in categories:
            category.lead_count = queryset.filter(category=category).count()
